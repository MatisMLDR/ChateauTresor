...
const AttenteAcceptationEquipe = () => {
  return (
    <div className='h-screen flex flex-col justify-center text-center items-center pb-24 max-w-lg mx-auto'>
      <h1 className='text-3xl font-bold mb-4'>En attente de validation</h1>
