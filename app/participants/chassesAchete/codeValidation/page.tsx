...
const CodeValidationPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <button
        onClick={() => router.push(`/participants/chassesAchete/gameInterface?enigmeId=${enigmeId}`)}
          ...
          <AlertDialogFooter>
            <AlertDialogAction
              onClick={() => {
                ...
                router.push('/participants/chassesAchete'); // Rediriger vers la liste des chasses
              }}
            >
              OK
            </AlertDialogAction>
