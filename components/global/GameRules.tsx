    ...
    <div className="container max-w-6xl py-8">
      <Card className="p-6">
        ...
        <div className="space-y-8">
          ...
          {/* Article 1 */}
          <div>
            <h2 className="text-xl font-semibold mb-4">Règle 1 : Système de points</h2>
            <p>
          ...
          {/* Règle 2 */}
          <div>
            <h2 className="text-xl font-semibold mb-4">Règle 2 : Récompenses</h2>
            <p>
          ...
          {/* Règle 3 */}
          <div>
            <h2 className="text-xl font-semibold mb-4">Règle 3 : Avis et retours</h2>
            <p>
          ...
          {/* Règle 4 */}
          <div>
            <h2 className="text-xl font-semibold mb-4">Règle 4 : Classement général</h2>
            <p>
