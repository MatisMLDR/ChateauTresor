          ...
          <div className="space-y-2">
            {type === "participant" ? (
              <h1 className="text-3xl font-extrabold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl text-[#2b4e73]">
                Château Trésor, <span className="text-[#f7c46d]">une aventure en or</span>
              </h1>
            ) : (
              <h1 className="text-3xl font-extrabold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl text-[#2b4e73]">
                Plus d&apos;aventure, moins de tracas avec <span className="text-[#f7c46d]">Château Trésor</span>
              </h1>
            )}
            <p className="text-muted-foreground md:text-xl text-[#6c757d]">
            {
              type === "organisateur" ?
                ...
                : "Venez participer à une expérience unique dans les châteaux de la Loire et soyez récompensés."
            }
            </p>
        </div>
